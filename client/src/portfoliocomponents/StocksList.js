...
const StocksList = ({addToPortfolio, selectedUser}) => {
 ...
 return (
    <>
        <StocksItem selectedUser={selectedUser} addToPortfolio={addToPortfolio} MSFT={MSFTDaily} META={METADaily} NVDA={NVDADaily} WMT={WMTDaily} XOM={XOMDaily} IBM={IBMDaily} TSLA={TSLADaily} AAPL={AAPLDaily}/>
    </>
  )
}
